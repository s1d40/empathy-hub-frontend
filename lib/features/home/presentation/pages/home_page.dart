...
import 'package:anonymous_hubs/features/feed/presentation/widgets/feed_widget.dart'; // Import the FeedWidget
import 'package:anonymous_hubs/features/feed/presentation/pages/create_post_page.dart'; // Import the CreatePostPage
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:anonymous_hubs/features/feed/presentation/cubit/create_post_cubit/create_post_cubit.dart'; // Import CreatePostCubit
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Feed - $currentUsername'),
